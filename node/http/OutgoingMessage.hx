...
@:jsRequire("http", "OutgoingMessage") extern class OutgoingMessage extends node.stream.Writable {
	...
	**/
	...
	/**
		...
		```
	**/
	@:overload(function(chunk:Dynamic, ?cb:() -> Void):OutgoingMessage { })
	@:overload(function(chunk:Dynamic, encoding:global.BufferEncoding, ?cb:() -> Void):OutgoingMessage { })
	function end(?cb:() -> Void):OutgoingMessage;
	/**
	...
	**/
	function destroy(?error:js.lib.Error):OutgoingMessage;
	/**
		Event emitter
