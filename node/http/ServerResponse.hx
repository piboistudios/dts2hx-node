...
@:jsRequire("http", "ServerResponse") extern class ServerResponse extends OutgoingMessage {
	...
	**/
	...
	/**
		...
		```
	**/
	@:overload(function(chunk:Dynamic, ?cb:() -> Void):ServerResponse { })
	@:overload(function(chunk:Dynamic, encoding:global.BufferEncoding, ?cb:() -> Void):ServerResponse { })
	function end(?cb:() -> Void):ServerResponse;
	/**
	...
	**/
	function destroy(?error:js.lib.Error):ServerResponse;
	/**
		Event emitter
